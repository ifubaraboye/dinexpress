...
import { ChevronRight, DollarSign, Package, TrendingUp, MapPin } from "lucide-react";
import { Button } from "@/components/ui/button";

export default function RunnerDashboard() {
  const [loading, setLoading] = useState(false);
  const [earnings, setEarnings] = useState({ today: 4500, week: 32000, total: 150000 });
  const [availableOrders, setAvailableOrders] = useState(3);
           ...
           <div className="grid grid-cols-2 gap-4">
              <div className="bg-gray-50 rounded-[32px] p-6 border border-gray-100 flex flex-col justify-between h-40">
                 ...
                 <div>
                    ...
                    <p className="text-3xl font-black text-gray-900 mt-1">₦{earnings.today.toLocaleString()}</p>
                 </div>
              </div>
              ...
              <div className="bg-gray-50 rounded-[32px] p-6 border border-gray-100 flex flex-col justify-between h-40">
                 ...
                 <div>
                    ...
                    <p className="text-3xl font-black text-gray-900 mt-1">₦{earnings.week.toLocaleString()}</p>
                 </div>
              </div>
           </div>
        </section>
        ...
        <section className="bg-red-600 rounded-[40px] p-7 text-white shadow-2xl shadow-red-100 relative overflow-hidden group">
           ...
           <div className="relative z-10">
              ...
              <div className="flex items-end justify-between">
                 <div>
                    <span className="text-7xl font-black tracking-tighter leading-none">{availableOrders}</span>
        ...
        <section className="space-y-4">
           ...
           <div className="bg-white border border-gray-100 rounded-[32px] p-2 shadow-sm">
              <div className="grid grid-cols-3 divide-x divide-gray-100">
                 ...
                 <div className="py-6 text-center">
                    <p className="text-3xl font-black text-gray-900 tracking-tighter">98%</p>
                    <p className="text-[10px] uppercase font-bold text-gray-400 mt-2 tracking-widest">On Time</p>
                 </div>
                 <div className="py-6 text-center">
                    <p className="text-3xl font-black text-gray-900 tracking-tighter">124</p>
                    <p className="text-[10px] uppercase font-bold text-gray-400 mt-2 tracking-widest">Total</p>
                 </div>
              </div>
           </div>
        </section>
