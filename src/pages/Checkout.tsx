...
export default function Checkout() {
  ...
  const totalAmount = (payload?.subtotal || 0) + 500 + (payload?.takeaway_fee || 0) + transferCharge;
  ...
  return (
    <div className="min-h-screen bg-white font-sans overflow-x-hidden pt-[85px]">
      ...
      <div className="fixed top-0 left-0 right-0 z-50 w-full border-b border-gray-100 bg-white/80 backdrop-blur-md h-16 px-6 lg:px-12 flex items-center gap-4">
        <button onClick={() => step === "payment" ? setStep("details") : navigate(-1)} className="p-2 -ml-2 hover:bg-gray-50 rounded-full transition-colors cursor-pointer">
          <ArrowLeft className="w-6 h-6 text-gray-900" />
        </button>
        <h1 className="text-xl font-black tracking-tight text-gray-900">{step === "details" ? "Delivery Details" : "Payment"}</h1>
      </div>
      ...
      <div className="max-w-2xl mx-auto border-x border-gray-50 shadow-sm min-h-[calc(100vh-85px)] flex flex-col pb-20">
        ...
        {step === "details" ? (
          <div className="flex-1 px-6 pt-10 space-y-10 animate-in fade-in slide-in-from-right-4 duration-500">
               ...
               <div className="space-y-4 bg-gray-50 rounded-[32px] p-6 border border-gray-100">
                  <div className="space-y-2">
                    ...
                    <Input 
                      ...
                      className="h-14 rounded-2xl bg-white border-transparent focus:border-red-200 transition-all text-sm font-bold shadow-sm"
                    />
                  </div>
                  {!isGift && (
                    <div className="space-y-2">
            ...
            <section className="space-y-4">
               <button 
                 ...
                 className={cn(
                   "w-full flex items-center justify-between p-6 rounded-[28px] border-2 transition-all",
                   isGift ? "border-red-600 bg-red-50/30" : "border-gray-50 bg-white"
                 )}
               >
                  <div className="flex items-center gap-4">
                    <div className={cn("w-10 h-10 rounded-xl flex items-center justify-center transition-colors", isGift ? "bg-red-600 text-white" : "bg-gray-100 text-gray-400")}>
                      <Gift size={20} />
                    </div>
                    <div className="text-left">
                      <p className="font-bold text-gray-900">Send as a gift</p>
                      <p className="text-[10px] font-bold text-gray-400 uppercase tracking-tight">Surprise someone today</p>
                    </div>
                  </div>
                  <div className={cn("w-6 h-6 rounded-full border-2 flex items-center justify-center transition-all", isGift ? "border-red-600" : "border-gray-200")}>
                    {isGift && <div className="w-3 h-3 bg-red-600 rounded-full animate-in zoom-in-50" />}
                  </div>
               </button>

               {isGift && (
                 <div className="space-y-4 bg-gray-50 rounded-[32px] p-6 border border-gray-100 animate-in slide-in-from-top-4 duration-300">
                    <div className="space-y-2">
                      ...
                      <Input 
                        ...
                        className="h-14 rounded-2xl bg-white border-transparent shadow-sm font-bold"
                      />
                    </div>
                    <div className="space-y-2">
                      <label className="text-[10px] font-black uppercase tracking-widest text-gray-400 ml-1">Recipient Phone</label>
                      <Input 
                        value={giftPhone}
            ...
            <div className="pt-6">
               <Button 
                 ...
                 className="w-full h-16 rounded-[28px] bg-gray-900 hover:bg-black text-white font-black text-lg shadow-xl shadow-gray-100 transition-all active:scale-95"
               >
                 Review Order & Pay
               </Button>
            </div>
          ...
          <div className="flex flex-col animate-in fade-in slide-in-from-left-4 duration-500">
            ...
            <div className="px-6 py-10 border-b border-gray-100 bg-gray-50/80">
              <h2 className="text-[10px] font-black uppercase tracking-[0.2em] text-gray-400 mb-6 px-1 text-center">Final Summary</h2>
              <div className="space-y-4 text-sm max-w-md mx-auto">
                ...
                <div className="flex justify-between pt-6 mt-4 border-t border-gray-200 px-1">
                  <span className="font-black text-gray-900 text-base uppercase tracking-tight">Total</span>
            ...
            <div className="px-6 pt-10 pb-12 flex flex-col items-center">
              <div className="space-y-8 w-full max-w-md">
                  ...
                  >
                    <div className="flex items-center gap-5">
                      ...
                      <div className="text-left">
                        ...
                        <span className="text-xs font-semibold text-gray-400 uppercase tracking-tighter">Instant & Secure</span>
                      </div>
                    </div>
                ...
                <div className="space-y-4 pt-4">
                  ...
                  >
                    {loading ? <Loader2 className="animate-spin" size={24} /> : `Complete Order • ₦${totalAmount.toLocaleString()}`}
                  </Button>
                  <button 
        ...
        <div className="mt-auto flex items-center justify-center gap-2 text-gray-300 w-full pt-12 pb-8">
          <ShieldCheck size={16} />
          <span className="text-[10px] font-black uppercase tracking-[0.2em]">Secured by DineXpress</span>
        </div>
      </div>
    </div>
  );
